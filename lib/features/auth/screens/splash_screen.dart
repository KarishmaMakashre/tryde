...
class _OnboardingScreenState extends State<OnboardingScreen>
  ...
  final List<Map<String, dynamic>> pages = [
    {
      ...
      'desc':
          'Easy and quick cab booking with just a few taps.\nGet reliable rides anytime, anywhere with our advanced booking system.',
      'image':
          AppConstants.splashOnePath,
    ...
    },
    {
      ...
      'desc':
          'Need help with moving? Our professional porter service is here to assist you with all your moving and delivery needs.',
      'image':
          AppConstants.splashTwoPath,
    ...
    },
    {
      ...
      'desc':
          'Access both cab booking and porter services from a single platform. Simple, fast, and reliable solution for all your needs.',
      'image':
          AppConstants.splashThreePath,
  ...
  void initState() {
    ...
    _slide = _animC
        .map((c) =>
            Tween(begin: Offset(0, .25), end: Offset.zero).animate(
              CurvedAnimation(parent: c, curve: Curves.easeOut),
            ))
        .toList();
  ...
  Widget card(Map p, int index) {
    double h = MediaQuery.of(context).size.height * .46; // SMALLER HEIGHT
                ...
                child: Column(
                  children: [
                    ...
                    ScaleTransition(
                      ...
                      child: Container(
                        height: w * 0.78, // PERFECT SQUARE LOOK
                        width: w * 0.78,
                        decoration: BoxDecoration(
